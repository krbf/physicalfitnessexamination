...
public class UnitAnalysisFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_unit_analysis, null);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //加载网络URL
        wvKbiGather.loadUrl(Constants.IP + "assessment/assessmentDwfxH5");
        //设置在当前WebView继续加载网页
