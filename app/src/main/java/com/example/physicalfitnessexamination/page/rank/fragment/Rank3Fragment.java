 ...
 * Use the {@link Rank3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Rank3Fragment extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment Rank3Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Rank3Fragment newInstance(String param1, String param2) {
        Rank3Fragment fragment = new Rank3Fragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        gvView = view.findViewById(R.id.gv_view);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        commonAdapter = new CommonAdapter<AllAroundBean>(getContext(), R.layout.item_rank3_fragment, list) {
            @Override
            public void convert(ViewHolder viewHolder, AllAroundBean allAroundBean) {
                ...
                viewHolder.setText(R.id.tv_clause, allAroundBean.getNAME());
            }
        };
    ...
    public void getData(String org_id, String gw) {
        ...
        map.put("gw", gw);
        OkhttpUtil.okHttpPost(Api.GETORGSUBJECTLIST4BSYM, map, new CallBackUtil.CallBackString() {
            @Override
